...
class Agent extends CI_Controller {
    ...
    public function Employees(){
        ...
        $data['employee'] = $this->admin_model->emselect();
	...
	$blood = $this->input->post('blood');		
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->admin_model->Does_email_exists($email) && $password != $confirm){
            ...
            if (!$this->upload->do_upload('image_url')) {
                ...
                if($id){
            $success = $this->admin_model->Update($data,$id); 
            #$this->session->set_flashdata('feedback','Successfully Updated');
            echo "Successfully Updated";
                } else {
            $success = $this->admin_model->Add($data);
	...
	$blood = $this->input->post('blood');		
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $employee = $this->admin_model->GetBasic($id);
