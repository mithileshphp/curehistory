      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Doctor</h3>
                </div>
    ...
    <?php $depvalue = $this->employee_model->getdepartment(); ?>
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/doctor" class="text-white"><i class="" aria-hidden="true"></i> Doctor List</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-user-o" aria-hidden="true"></i> Add New Doctor  <span class="pull-right " ></span></h4>
                            </div>
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <!-- <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <select name="role" class="form-control custom-select" required>
                                            ...
                                            <option value="AGENT">Doctor</option>
                                            <option value="DOCTOR">Agent</option>
                                        </select>
                                    </div> -->
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Gender </label>
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="number" name="registration" class="form-control form-control-line" value="" placeholder="Registration Number"> 
                                    </div>
