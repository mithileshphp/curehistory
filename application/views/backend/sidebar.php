            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php if($this->session->userdata('user_type')=='AGENT'  || $this->session->userdata('user_type')=='SUPER ADMIN'){ ?>
                        <li> <a class=" waves-effect waves-dark" href="<?php echo base_url(); ?>Agent" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Agent</span></a>
                            <!-- <ul aria-expanded="false" class="collapse">
                        ...
                        <?php } ?>
                        <?php if($this->session->userdata('user_type')=='DOCTOR' || $this->session->userdata('user_type')=='SUPER ADMIN'){ ?>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url(); ?>Doctor" aria-expanded="false"><i class="fa fa-user-md"></i><span class="hide-menu">Doctor </span></a>
                            <!-- <ul aria-expanded="false" class="collapse">
                        ...
                        <?php } ?>
                        <?php if($this->session->userdata('user_type')=='DOCTOR' || $this->session->userdata('user_type')=='AGENT' || $this->session->userdata('user_type')=='SUPER ADMIN'){ ?>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url(); ?>Patient" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Patient Deatils</span></a>
                            <!-- <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance">Attendance List </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Save_Attendance">Add Attendance </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance_Report">Attendance Report </a></li>
                        ...
                        <?php } ?>
                        <!-- <li> <a class="waves-effect waves-dark" href="<?php echo base_url(); ?>employee/disease" aria-expanded="false"><i class="fa fa-qrcode"></i><span class="hide-menu">Disease</span></a> -->
                            <!-- <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance">Attendance List </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Save_Attendance">Add Attendance </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance_Report">Attendance Report </a></li>
                        ...
                        <!-- <li> <a class="waves-effect waves-dark" href="<?php echo base_url(); ?>employee/qrcode" aria-expanded="false"><i class="fa fa-qrcode"></i><span class="hide-menu">QR Code List</span></a> -->
                            <!-- <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance">Attendance List </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Save_Attendance">Add Attendance </a></li>
                                <li><a href="<?php echo base_url(); ?>attendance/Attendance_Report">Attendance Report </a></li>
