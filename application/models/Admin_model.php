<?php
  ...
  public function disease_suffering_from(){
    $query = $this->db->get('disease_suffering_from');
    $result = $query->result();
    return $result;
    }

    public function high_risk_disease(){
      $query = $this->db->get('high_risk_disease');
      $result = $query->result();
      return $result;
      }
    ...
    public function ongoing_medical($data){
      $this->db->insert('ongoing_medical',$data);
    }

  public function update_blood_report($data){
    $this->db->insert('update_blood_report',$data);
}
